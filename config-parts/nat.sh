...
# Port forward
set nat destination rule 101 description 'Port forward 50413 to qBittorrent'
set nat destination rule 101 destination port '50413'
set nat destination rule 101 protocol 'tcp_udp'
set nat destination rule 101 inbound-interface 'eth0'
set nat destination rule 101 translation address '192.168.15.10'
