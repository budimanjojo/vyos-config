...
set nat destination rule 101 translation address '192.168.5.0'
...
set nat destination rule 105 description 'Force NTP for IOT VLAN'
set nat destination rule 105 destination address '!192.168.69.1'
set nat destination rule 105 destination port '123'
set nat destination rule 105 inbound-interface 'eth1.69'
set nat destination rule 105 protocol 'udp'
set nat destination rule 105 translation address '192.168.69.1'
set nat destination rule 105 translation port '123'

set nat destination rule 106 description 'Force NTP for SERVER VLAN'
set nat destination rule 106 destination address '!192.168.200.1'
set nat destination rule 106 destination port '123'
set nat destination rule 106 inbound-interface 'eth1.200'
set nat destination rule 106 protocol 'udp'
set nat destination rule 106 translation address '192.168.200.1'
set nat destination rule 106 translation port '123'

set nat destination rule 107 description 'Force NTP for GUEST VLAN'
set nat destination rule 107 destination address '!192.168.250.1'
set nat destination rule 107 destination port '123'
set nat destination rule 107 inbound-interface 'eth1.250'
set nat destination rule 107 protocol 'udp'
set nat destination rule 107 translation address '192.168.250.1'
set nat destination rule 107 translation port '123'

set nat destination rule 108 description 'Force NTP for WIREGUARD'
set nat destination rule 108 destination address '!10.10.0.1'
set nat destination rule 108 destination port '123'
set nat destination rule 108 inbound-interface 'wg0'
set nat destination rule 108 protocol 'udp'
set nat destination rule 108 translation address '10.10.0.1'
