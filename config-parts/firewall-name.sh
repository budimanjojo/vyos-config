...
set firewall name SERVER-LOCAL rule 80 description 'allow access to smartctl-exporter from k8s nodes'
set firewall name SERVER-LOCAL rule 80 action 'accept'
set firewall name SERVER-LOCAL rule 80 protocol 'tcp'
set firewall name SERVER-LOCAL rule 80 source group address-group 'k8s_nodes'
set firewall name SERVER-LOCAL rule 80 destination port '9633'
...
set firewall name SERVER-HOME rule 20 description 'allow access to node-exporter from k8s nodes'
set firewall name SERVER-HOME rule 20 action 'accept'
set firewall name SERVER-HOME rule 20 protocol 'tcp'
set firewall name SERVER-HOME rule 20 source group address-group 'k8s_nodes'
set firewall name SERVER-HOME rule 20 destination port '9100'
set firewall name SERVER-HOME rule 30 description 'allow access to smartctl-exporter from k8s nodes'
set firewall name SERVER-HOME rule 30 action 'accept'
set firewall name SERVER-HOME rule 30 protocol 'tcp'
set firewall name SERVER-HOME rule 30 source group address-group 'k8s_nodes'
set firewall name SERVER-HOME rule 30 destination port '9633'
