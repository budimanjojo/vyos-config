...
set firewall name HOME-SERVER rule 20 description 'allow access to k8s nodes from trusted devices'
set firewall name HOME-SERVER rule 20 action 'accept'
set firewall name HOME-SERVER rule 20 source group address-group 'trusted_devices'
set firewall name HOME-SERVER rule 20 destination group address-group 'k8s_nodes'
...
set firewall name WAN-SERVER rule 10 destination port '80,443'
