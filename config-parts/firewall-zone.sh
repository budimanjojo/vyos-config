...
set firewall zone LAN1 from HOME firewall name 'HOME-LAN1'
...
set firewall zone HOME interface 'eth1.50'
set firewall zone HOME default-action 'drop'
set firewall zone HOME from LOCAL firewall name 'LOCAL-HOME'
set firewall zone HOME from LAN1 firewall name 'LAN1-HOME'
set firewall zone HOME from IOT firewall name 'IOT-HOME'
set firewall zone HOME from SERVER firewall name 'SERVER-HOME'
set firewall zone HOME from GUEST firewall name 'GUEST-HOME'
set firewall zone HOME from CONTAINERS firewall name 'CONTAINERS-HOME'
set firewall zone HOME from WIREGUARD firewall name 'WIREGUARD-HOME'
...
set firewall zone SERVER from HOME firewall name 'HOME-SERVER'
...
set firewall zone GUEST from HOME firewall name 'HOME-GUEST'
...
set firewall zone WIREGUARD from HOME firewall name 'HOME-WIREGUARD'
