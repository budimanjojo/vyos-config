...
set container name adguardhome image 'docker.io/adguard/adguardhome:v0.107.74'
...
set container name node-exporter image 'quay.io/prometheus/node-exporter:v1.11.1'
...
set container name cloudflare-ddns image 'docker.io/favonia/cloudflare-ddns:1.16.2'
