...
set container name adguardhome image 'docker.io/adguard/adguardhome:v0.107.79'
...
set container name node-exporter image 'quay.io/prometheus/node-exporter:v1.12.1'
...
# omada-controller
set container name omada-controller image 'docker.io/mbentley/omada-controller:6.3'
...
set container name cloudflare-ddns image 'docker.io/favonia/cloudflare-ddns:1.17.0'
