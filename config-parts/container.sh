...
set container name adguardhome image 'docker.io/adguard/adguardhome:v0.107.73'
...
# omada-controller
set container name omada-controller image 'docker.io/mbentley/omada-controller:6.2'
...
set container name cloudflare-ddns image 'docker.io/favonia/cloudflare-ddns:1.16.1'
