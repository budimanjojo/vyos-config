...
set protocols bgp neighbor 192.168.200.21 update-source SERVER
...
set protocols bgp neighbor 192.168.200.22 update-source SERVER
...
set protocols bgp neighbor 192.168.200.24 update-source SERVER
