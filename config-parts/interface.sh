...
set interfaces wireguard wg0 peer android-phone allowed-ips '10.10.0.2/32'
set interfaces wireguard wg0 peer android-phone persistent-keepalive '15'
set interfaces wireguard wg0 peer android-phone public-key 'WCESN/SAmvJekIxJSlmw+2FQg+uhvlseGhGvN/VZ0AU='
...
set interfaces wireguard wg0 peer work-pc public-key 'P1l3T3RbpeUiCAJXx7ZhT+IZhu5Wb9tq191uHt3iwDM='
